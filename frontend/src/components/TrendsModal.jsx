...
const TrendsModal = ({ location, hourlyTrends, hasExtendedHistory, onClose }) => {
  // Show message if no trends data available
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ marginBottom: '16px', color: '#333' }}>No Trends Data Available</h2>
          <p style={{ marginBottom: '24px', color: '#666' }}>
            Hourly forecast data is not available for {location} at the moment. Please try again later.
          </p>
          <button
            onClick={onClose}
            style={{
